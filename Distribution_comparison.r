...
data<- read.csv("C:/Users/babies.csv")
...
legend('topright', c('Never', 'Current', 'Until_pregnancy','Once'),
...
#what are the smoking habits of most women.
#Descriptive analysis of mother's smoking habits
